                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-5 form-box">
                          ...
                          <spring:url value="/entreprise/s'enregistrer" var="enregistrerURL"></spring:url>
                            <form:form action="${enregistrerURL }" method="post" modelAttribute="entreprise" cssClass="registration-form">
			                        ...
			                        <div class="form-group">
			                        	<label class="sr-only" for="prenom">secteur de travail</label>
			                        	
			                        	<form:input path="domaine" cssClass="form-last-name form-control" id="prenom" placeholder="secteur de travail"/>
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="niveau scolaire">niveau scolaire</label>
			                        	<form:input path="description" cssClass="form-about-yourself form-control" id="niveau scolaire" placeholder="une breve description de votre entreprise "/>
			                        ...
			                        <div class="form-group">
			                        	...
			                        	<form:input path="ville" cssClass="form-email form-control" id="tel" placeholder="ville"/>
			                        	
			                        </div>
			                         <div class="form-group">
			                        	<label class="sr-only" for="tel">mot de passe </label>
			                        	<form:password path="password" cssClass="form-email form-control" id="tel" placeholder="votre mote de passe" />
